...
for parent, dirnames, filenames in os.walk(rootdir):
    for filename in filenames:
        if filename.find("ConfigTable.cpp") > 0:
            name = filename[0:len(filename) - len("ConfigTable.cpp")]
            # print "filename is:" + name
            class_names.append(name)

head_mgr_path = "./Result/cpp/ConfigMgr.h"
...
mgr_path = "./Result/cpp/ConfigMgr.cpp"
